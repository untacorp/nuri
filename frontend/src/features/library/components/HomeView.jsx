    ...
    <div className="max-w-6xl mx-auto px-6 py-16 animate-in fade-in duration-300">
      <div className="flex items-center justify-between mb-12 pb-6 border-b border-border-main">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold uppercase tracking-wider font-mono">Koleksi Buku Saya</h1>
        </div>
        <button 
          onClick={() => onOpenModal('book', null)} 
          className="flex items-center gap-2 px-4 py-2 text-xs font-bold uppercase tracking-wider bg-accent text-accent-foreground border border-accent hover:bg-accent-hover hover:border-accent-hover rounded-none transition-colors font-mono"
        >
          <Plus size={14} />
          Buku Baru
        </button>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        ...
        >
          ...
          <span className="font-bold text-xs uppercase tracking-wider font-mono">Buku Baru</span>
        </div>
      </div>
    </div>
  );
